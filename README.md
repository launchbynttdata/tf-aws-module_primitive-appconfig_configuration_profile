# Terraform AWS Module: AppConfig Configuration Profile (Primitive)
...
This primitive module manages one AWS AppConfig configuration profile resource and exposes the commonly used Terraform provider arguments for composition by collection and reference architecture modules.

## Usage

```hcl
module "example" {
  source = "terraform.registry.launch.nttdata.com/module_primitive/appconfig_configuration_profile/aws"
...
| Name | Type |
|------|------|
| [aws_appconfig_configuration_profile.configuration_profile](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/appconfig_configuration_profile) | resource |
...
| <a name="input_description"></a> [description](#input\_description) | Description of the AppConfig configuration profile. Must be at most 1024 characters. | `string` | `null` | no |
| <a name="input_kms_key_identifier"></a> [kms\_key\_identifier](#input\_kms\_key\_identifier) | KMS key identifier for encrypting hosted configuration data. | `string` | `null` | no |
| <a name="input_location_uri"></a> [location\_uri](#input\_location\_uri) | URI of the configuration source. Use hosted for AWS AppConfig hosted configurations. | `string` | n/a | yes |
| <a name="input_name"></a> [name](#input\_name) | Name of the AppConfig configuration profile. Must be 1 to 64 characters. | `string` | n/a | yes |
...
| <a name="input_retrieval_role_arn"></a> [retrieval\_role\_arn](#input\_retrieval\_role\_arn) | IAM role ARN AWS AppConfig assumes to retrieve configuration from external sources. | `string` | `null` | no |
...
| <a name="input_type"></a> [type](#input\_type) | Configuration profile type. Use AWS.AppConfig.FeatureFlags for hosted feature flag documents. | `string` | `null` | no |
| <a name="input_validators"></a> [validators](#input\_validators) | Validators for the configuration profile. Maximum of 2 validators. Valid validator types are JSON\_SCHEMA and LAMBDA. content is required by AWS for JSON\_SCHEMA validators. | `list(object({ type = string, content = optional(string) }))` | `[]` | no |
